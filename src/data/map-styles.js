...
module.exports = {
  ...
  "sources": {
    "openmaptiles": {
      "type": "vector",
      "url": "https://api.maptiler.com/tiles/v3/tiles.json?key=2WMJeCn0Sjg2SFwdVT3D#"
    }
  },
  "glyphs": "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=2WMJeCn0Sjg2SFwdVT3D",
  "layers": [
    {
      "id": "background",
      "type": "background",
