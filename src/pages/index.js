            ...
            <h1 className='ui header'>
              <div className='content'>
                ...
                <div className='sub header'>
                  In Zeiten von Selbstisolation und Social Distancing soll in Chur niemand alleine sein. Liest du gerne Geschichten via Skype vor, hast du Zeit für jemanden einzukaufen oder hast du sonst etwas anzubieten?
                  {' '}
                  <Link to={'/add'}>
